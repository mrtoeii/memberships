        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-2">
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="gender" id="gender" name="gender" value="male"   required>
            ...
            <div class="form-group col-md-2">
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="gender" id="gender" name="gender" value="female"  required>
